...
### 출력 
 ...
 <p>첫 번째 줄에 조건을 만족하는 수열이 존재한다면 <code><span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color="">YES</span></code>, 아니라면 <code><span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color="">NO</span></code>를 출력한다.</p>
